...
(/** @lends <global> */function($, window, document, undefined) {
			...
			else
			{
				...
				return function (data, type) {
					...
					if (data['error'] != null && data['error'] != undefined)
					{
						...
						if (errMsg.indexof("Session Time Out") != -1)
						{
							location.replace("home.do");
						}					
					}
					
					if (data['startIndex'] != null && data['startIndex'] != undefined)
					{					
						if(document.getElementById("hidstart") != null)
							document.getElementById("hidstart").value = data['startIndex'];						
					}
					
					if (data['endIndex'] != null && data['endIndex'] != undefined)
					{
						if(document.getElementById("hidend") != null)
							document.getElementById("hidend").value = data['endIndex'];						
					}
					
					if (data['totalRecords'] != null && data['totalRecords'] != undefined)
					{						
						if(document.getElementById("hidtot") != null)
							document.getElementById("hidtot").value = data['totalRecords'];						
					}
		...
		function _fnInitialise ( oSettings )
		{
			...
			if ( oSettings.sAjaxSource !== null && !oSettings.oFeatures.bServerSide )
			{
				...
				oSettings.fnServerData.call( oSettings.oInstance, oSettings.sAjaxSource, aoData, function(json) {
					...
					var displayInfo = "Showing " + startIndex + " to " + endIndex + " of " + totRec + " entries";
					
					if (startIndex == 0 || endIndex == 0 || totRec == 0)
						displayInfo = "Showing _START_ to _END_ of _TOTAL_ entries";
		
					oSettings.oLanguage.sInfo = displayInfo;
	...
	$.extend( DataTable.ext.oStdClasses, {
		...
		"sPagePreviousSet": "previousSet",		
		"sPageNext": "next",
		"sPageNextSet": "nextSet",
		"sPageLast": "last",
	...
	$.extend( DataTable.ext.oPagination, {
		...
		"full_numbers": {
			...
			"fnInit": function ( oSettings, nPaging, fnCallbackDraw )
			{
				...
				$(nPaging).append(
					'<a id=PS name=PS tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePreviousSet +'"onclick="return validateTableNextPrevSetSubmit(this)">'+'|<<'+'</a>'+
					'<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPagePrevious+'">'+oLang.sPrevious+'</a>'+
					'<a  tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageFirst+'">'+oLang.sFirst+'</a>'+					
					'<span></span>'+
					'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageLast+'">'+oLang.sLast+'</a>'+
					'<a tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNext+'">'+oLang.sNext+'</a>'+
					'<a id=NS name=NS tabindex="'+oSettings.iTabIndex+'" class="'+oClasses.sPageButton+" "+oClasses.sPageNextSet+'" onclick="return validateTableNextPrevSetSubmit(this)">'+'>>|'+'</a>'
			...
			{		
				...
				if(document.getElementById("hidstart") != null)
					hidStartIndex = document.getElementById("hidstart").value;
				if(document.getElementById("hidend") != null)
					hidEndIndex = document.getElementById("hidend").value;
				if(document.getElementById("hidtot") != null)
					hidTotRec = document.getElementById("hidtot").value;
				...
				{					
					if (iStartButton == iEndButton)
						sList += '<a tabindex="'+oSettings.iTabIndex+'" disabled class="'+oClasses.sPageButtonActive+'">'+oSettings.fnFormatNumber(i)+'</a>';
					else
				...
				for ( i=0, iLen=an.length ; i<iLen ; i++ )
				{
					...
					anStatic = [
						anButtons[0], anButtons[1], anButtons[2], 
						anButtons[anButtons.length-3], anButtons[anButtons.length-2], anButtons[anButtons.length-1]
					];
	
					$(anStatic).removeClass( oClasses.sPageButton+" "+oClasses.sPageButtonActive+" "+oClasses.sPageButtonStaticDisabled );
					
					$([anStatic[1], anStatic[2]]).addClass( 
						(iCurrentPage==1) ?
							oClasses.sPageButtonStaticDisabled :
							oClasses.sPageButton
					);
					$([anStatic[3], anStatic[4]]).addClass(
					...
					$([anStatic[0]]).addClass(
							(Number(hidStartIndex) <= 1) ?
								oClasses.sPageButtonStaticDisabled :
								oClasses.sPageButton					
					);
					
					$([anStatic[5]]).addClass(
							(Number(hidEndIndex) >= Number(hidTotRec)) ?
								oClasses.sPageButtonStaticDisabled :
								oClasses.sPageButton
					);
